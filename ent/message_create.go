...
func (mc *MessageCreate) SetSent(i int) *MessageCreate {
	mc.mutation.SetSent(i)
	return mc
}

// SetResent sets the "resent" field.
func (mc *MessageCreate) SetResent(i int) *MessageCreate {
	mc.mutation.SetResent(i)
	return mc
}
...
func (mc *MessageCreate) SetJobId(i int) *MessageCreate {
	mc.mutation.SetJobId(i)
	return mc
}
...
func (mc *MessageCreate) check() error {
	...
	if _, ok := mc.mutation.Resent(); !ok {
		return &ValidationError{Name: "resent", err: errors.New(`ent: missing required field "Message.resent"`)}
	}
	if _, ok := mc.mutation.SentAt(); !ok {
		return &ValidationError{Name: "sentAt", err: errors.New(`ent: missing required field "Message.sentAt"`)}
	}
	if _, ok := mc.mutation.JobId(); !ok {
		return &ValidationError{Name: "jobId", err: errors.New(`ent: missing required field "Message.jobId"`)}
	}
	return nil
}
...
func (mc *MessageCreate) createSpec() (*Message, *sqlgraph.CreateSpec) {
	...
	if value, ok := mc.mutation.Resent(); ok {
	...
	if value, ok := mc.mutation.JobId(); ok {
