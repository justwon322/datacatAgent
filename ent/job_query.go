...
func (jq *JobQuery) FirstID(ctx context.Context) (id int32, err error) {
	var ids []int32
...
func (jq *JobQuery) FirstIDX(ctx context.Context) int32 {
...
func (jq *JobQuery) OnlyID(ctx context.Context) (id int32, err error) {
	var ids []int32
...
func (jq *JobQuery) OnlyIDX(ctx context.Context) int32 {
...
func (jq *JobQuery) IDs(ctx context.Context) (ids []int32, err error) {
...
func (jq *JobQuery) IDsX(ctx context.Context) []int32 {
	ids, err := jq.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (jq *JobQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(job.Table, job.Columns, sqlgraph.NewFieldSpec(job.FieldID, field.TypeInt32))
	_spec.From = jq.sql
