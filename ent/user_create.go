...
func (uc *UserCreate) SetLastAccessed(t time.Time) *UserCreate {
	uc.mutation.SetLastAccessed(t)
	return uc
}
...
func (uc *UserCreate) check() error {
	...
	if _, ok := uc.mutation.LastAccessed(); !ok {
		return &ValidationError{Name: "lastAccessed", err: errors.New(`ent: missing required field "User.lastAccessed"`)}
	}
	if _, ok := uc.mutation.UserGroupId(); !ok {
		return &ValidationError{Name: "userGroupId", err: errors.New(`ent: missing required field "User.userGroupId"`)}
	}
	return nil
}
...
func (uc *UserCreate) createSpec() (*User, *sqlgraph.CreateSpec) {
	...
	if value, ok := uc.mutation.LastAccessed(); ok {
