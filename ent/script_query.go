...
func (sq *ScriptQuery) FirstID(ctx context.Context) (id int64, err error) {
	var ids []int64
...
func (sq *ScriptQuery) FirstIDX(ctx context.Context) int64 {
...
func (sq *ScriptQuery) OnlyID(ctx context.Context) (id int64, err error) {
	var ids []int64
...
func (sq *ScriptQuery) OnlyIDX(ctx context.Context) int64 {
...
func (sq *ScriptQuery) IDs(ctx context.Context) (ids []int64, err error) {
...
func (sq *ScriptQuery) IDsX(ctx context.Context) []int64 {
	ids, err := sq.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (sq *ScriptQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(script.Table, script.Columns, sqlgraph.NewFieldSpec(script.FieldID, field.TypeInt64))
	_spec.From = sq.sql
